<template>
  <div dir="rtl">
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="summary-card" elevation="0" variant="outlined">
          <v-card-text class="text-center pa-4">
            <div class="text-h5 font-weight-bold mb-1">{{ subcategories.length }}</div>
            <div class="text-caption text-grey">کل زیردسته‌ها</div>
          </v-card-text>
        </v-card>
      </v-col>
      <v-col cols="12" sm="6" md="3">
    ...
    <v-card elevation="0" variant="outlined">
      <v-card-title class="pa-4">لیست زیردسته‌ها</v-card-title>
      <v-divider></v-divider>
      <v-data-table
        :headers="headers"
        :items="subcategories"
        ...
        <template v-slot:item.actions="{ item }">
          <v-menu>
            ...
            <v-list>
              ...
              <v-list-item @click="deleteSubcategory(item)">
                <template v-slot:prepend>
