...
// Validate items prop
const isValidBreadcrumbItem = (item: any): item is BreadcrumbItem => {
  return (
    typeof item === 'object' &&
...
if (import.meta.dev && !props.items.every(isValidBreadcrumbItem)) {
  console.warn('Breadcrumb: Invalid items format')
}
</script>
