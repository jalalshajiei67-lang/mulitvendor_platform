...
const helpText = computed(() => {
  ...
  const helpTexts: Record<string, string> = {
    ...
    mini_website: 'در تب "فروشگاه" نام فروشگاه، توضیحات کامل و تصویر بنر جذاب اضافه کنید. این صفحه اولین برداشت مشتری از شما است.',
    products: 'در تب "محصولات" حداقل ۳ محصول با تصویر واضح، توضیحات کامل و قیمت مشخص اضافه کنید. محصولات با جزئیات بیشتر، فروش بهتری دارند.',
    team: 'در تب "تیم" حداقل یک نفر از اعضای کلیدی تیم خود را با تصویر و سمت معرفی کنید. این به اعتبار شما کمک می‌کند.',
