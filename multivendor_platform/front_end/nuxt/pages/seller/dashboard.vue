          ...
          <v-window v-model="tab">
            ...
            <v-window-item value="home">
              <div class="py-2">
                    ...
                    >
                      <v-card-text class="pa-4">
                        <div class="d-flex align-center justify-space-between">
                          <div>
                            <div class="text-caption mb-1">تعداد محصولات</div>
                            <div class="text-h5 font-weight-bold">
                              {{ dashboardData.total_products || 0 }}
                            </div>
                            <div class="text-caption opacity-70">
                              {{ dashboardData.active_products || 0 }} از فعال
                            </div>
                          </div>
                      ...
                      <v-card-text class="pa-4">
                        <div class="d-flex align-center justify-space-between">
                          <div>
                            ...
                            <div class="text-caption opacity-70">
                              {{ hasProductsUnderThreshold ? 'سفارش' : 'سفارش‌ها' }}
                            </div>
                          </div>
                  ...
                  <v-col cols="6" sm="4" md="3">
                    ...
                    >
                      <v-card-text class="pa-4">
                        <div class="d-flex align-center justify-space-between">
                          <div>
                            <div class="text-caption mb-1">بازدید محصولات</div>
                            <div class="text-h5 font-weight-bold">
                              {{ dashboardData.product_views || 0 }}
                            </div>
                            <div class="text-caption opacity-70">
                              مجموع بازدید محصولات
                            </div>
                          </div>
                  ...
                  <v-col cols="6" sm="4" md="3">
                    ...
                    >
                      <v-card-text class="pa-4">
                        <div class="d-flex align-center justify-space-between">
                          <div>
                            <div class="text-caption mb-1">تعداد نظرات</div>
                            <div class="text-h5 font-weight-bold">
                              {{ dashboardData.total_reviews || 0 }}
                            </div>
                            <div class="text-caption opacity-70">
                              میانگین نظرات به ستاره
                            </div>
                          </div>
                ...
                <!-- Premium Discount Box (Only for Free Plan Users) -->
                <v-row class="mb-6" v-if="isFreePlan">
                  <v-col cols="12">
                    <PremiumDiscountBox @upgrade="(code) => { discountCode = code; showPremiumDialog = true }" />
                  </v-col>
                </v-row>
                  ...
                  <v-col cols="12">
                    <v-card elevation="2" rounded="xl" class="pa-4">
                      <div class="d-flex align-center justify-space-between mb-4">
                        <div>
                          <div class="text-h6 font-weight-bold">مشتریان بالقوه شما (از طریق محصولات)</div>
                            <div class="text-body-2 text-medium-emphasis">
                              مشتریانی که محصولات شما را دیده‌اند و ممکن است علاقه‌مند باشند. با تکمیل پروفایل خود، مشتریان بیشتری را جذب کنید.
                            </div>
                        </div>
                        <v-btn
                          variant="text"
                      ...
                      <v-alert
                        ...
                        class="mb-0"
                      >
                        هیچ مشتری بالقوه‌ای یافت نشد. با افزودن محصولات بیشتر، مشتریان بیشتری جذب کنید و آنها را در اینجا ببینید.
                      </v-alert>
                        ...
                        >
                          <v-card rounded="xl" elevation="1" class="pa-4 h-100 d-flex flex-column gap-3">
                            ...
                            <div class="text-body-2 text-high-emphasis">
                              {{ lead.unique_needs || '╪¼╪▓╪ª█î╪º╪¬ ┘å█î╪º╪▓ ┘à╪┤╪¬╪▒█î ╪½╪¿╪¬ ┘å╪┤╪»┘ç ╪º╪│╪¬.' }}
                            </div>
                          </v-card>
                        </v-col>
                      </v-row>
                  ...
                  <v-col cols="12">
                    <v-card elevation="2" rounded="xl" class="pa-2">
                      <v-card-title class="d-flex align-center justify-space-between px-4 pt-4">
                        <span class="text-h6 font-weight-bold">سفارش‌ها اخیر</span>
                        <v-btn
                          variant="text"
                          color="primary"
                          class="px-2"
                        ...
                        <v-list lines="two">
                          ...
                          >
                            ...
                            <v-list-item-title class="font-weight-bold">
                              ╪│┘ü╪º╪▒╪┤ {{ order.order_number }}
                            </v-list-item-title>
                            <v-list-item-subtitle>
                              {{ order.buyer_username || '┌⌐╪º╪▒╪¿╪▒ ┘à┘ç┘à╪º┘å' }} ΓÇó <span class="text-high-emphasis">{{ formatPrice(order.total_amount) }}</span>
                            </v-list-item-subtitle>
                ...
                <v-row class="mb-4">
                  <v-col cols="12">
                    <v-card elevation="2" rounded="xl" class="pa-4">
                      <div class="d-flex align-center justify-space-between mb-4">
                        <div>
                          <div class="text-h6 font-weight-bold">مدیریت مشتریان</div>
                          <div class="text-body-2 text-medium-emphasis">
                            اطلاعات تماس مشتریان را که محصولات شما را دیده‌اند دریافت کنید. قیمت محصول = حداکثر قیمت برای نمایش.
                          </div>
                        </div>
                        <v-btn
                          variant="text"
                      ...
                      <v-alert
                        ...
                        class="mb-0"
                      >
                        هیچ مشتری بالقوه‌ای پیدا نشد. با افزودن محصولات بیشتر، مشتریان بیشتری پیدا کنید و اطلاعات تماس آنها را دریافت کنید.
                      </v-alert>
                        ...
                        >
                          <v-card rounded="xl" elevation="1" class="pa-4 h-100 d-flex flex-column gap-3">
                            ...
                            <v-sheet color="surface-variant" class="pa-3 rounded-lg">
                              ...
                              <div class="text-body-1 font-weight-bold">
                                {{ lead.contact_revealed ? lead.phone_number : (lead.phone_number || 'باید شماره تماس را دریافت کنید') }}
                              </div>
                            </v-sheet>
                            ...
                            >
                              {{ lead.contact_revealed ? 'اطلاعات تماس دریافت شد' : 'دریافت شماره تماس مشتری' }}
                            </v-btn>
                          </v-card>
                        </v-col>
                      </v-row>
            ...
            <v-window-item value="orders">
              <v-card elevation="2" rounded="xl" class="pa-4 mt-4">
                <div v-if="!hasProductsUnderThreshold" class="text-center pa-12">
                  ...
                  <h3 class="text-h5 font-weight-bold mb-4">محدودیت سفارش‌ها</h3>
                  <p class="text-body-1 text-medium-emphasis mb-6">
                    برای دسترسی به سفارش‌ها باید حداقل یک محصول با قیمت کمتر از ۱۰۰ میلیون تومان داشته باشید.
                  </p>
                  <v-btn
                    color="primary"
                    variant="flat"
                ...
                <div v-else>
                  <div class="d-flex align-center justify-space-between mb-6">
                    <h3 class="text-h6 font-weight-bold">سفارش‌ها</h3>
                    <v-btn
                      variant="text"
                      color="primary"
                      prepend-icon="mdi-refresh"
                  ...
                  <v-data-table
                    ...
                    :items-per-page="10"
                    class="elevation-0"
                    no-data-text="╪│┘ü╪º╪▒╪┤█î █î╪º┘ü╪¬ ┘å╪┤╪»"
                  >
                    <template v-slot:item.order_number="{ item }">
                      <span class="font-weight-bold">{{ item.order_number }}</span>
                    </template>
                    <template v-slot:item.buyer_username="{ item }">
                      {{ item.buyer_username || '┌⌐╪º╪▒╪¿╪▒ ┘à┘ç┘à╪º┘å' }}
                    </template>
                    <template v-slot:item.total_amount="{ item }">
                      <span class="font-weight-bold text-primary">{{ formatPrice(item.total_amount) }} ╪¬┘ê┘à╪º┘å</span>
                    </template>
                  ...
                  <v-card v-else-if="!loadingOrders && orders.length === 0" elevation="1" class="text-center pa-8">
                    ...
                    <p class="text-h6 mt-4 mb-2">┘ç┘å┘ê╪▓ ╪│┘ü╪º╪▒╪┤█î ╪½╪¿╪¬ ┘å╪┤╪»┘ç ╪º╪│╪¬</p>
                    <p class="text-body-2 text-grey">╪¿╪º ╪¬┌⌐┘à█î┘ä ┘╛╪▒┘ê┘ü╪º█î┘ä ┘ê ┘à╪¡╪╡┘ê┘ä╪º╪¬╪î ╪º╪╣╪¬┘à╪º╪» ╪«╪▒█î╪»╪º╪▒╪º┘å ╪▒╪º ╪¼┘ä╪¿ ┌⌐┘å█î╪» ╪¬╪º ╪º┘ê┘ä█î┘å ╪│┘ü╪º╪▒╪┤ ╪½╪¿╪¬ ╪┤┘ê╪».</p>
                  </v-card>
                </div>
              </v-card>
            </v-window-item>
            ...
            <v-window-item value="reviews">
              <v-card elevation="2" rounded="xl" class="pa-4 mt-4">
                <div class="d-flex align-center justify-space-between mb-6">
                  <h3 class="text-h6 font-weight-bold">نظرات مشتریان</h3>
                  <v-btn
                    variant="text"
                    color="primary"
                    prepend-icon="mdi-refresh"
                ...
                <v-card v-else-if="!loadingReviews && reviews.length === 0" elevation="1" class="text-center pa-8">
                  ...
                  <p class="text-h6 mt-4 mb-2">هیچ نظری یافت نشد</p>
                  <p class="text-body-2 text-grey">نظرات مشتریان درباره محصولات شما در اینجا نمایش داده خواهد شد و به بهبود پروفایل شما کمک می‌کند.</p>
                </v-card>
              </v-card>
            </v-window-item>
            ...
            <v-window-item value="invite">
              <v-card elevation="2" rounded="xl" class="pa-6 mt-4 text-center">
                <div v-if="!hasGoldTierOrAbove">
                  <v-icon size="96" color="warning" class="mb-4">mdi-lock</v-icon>
                  <h3 class="text-h5 font-weight-bold mb-4">╪¿╪«╪┤ ╪»╪╣┘ê╪¬ ┘é┘ü┘ä ╪º╪│╪¬</h3>
                  <p class="text-body-1 text-medium-emphasis mb-6">
                    ╪¿╪▒╪º█î ╪»╪│╪¬╪▒╪│█î ╪¿┘ç ╪¿╪«╪┤ ╪»╪╣┘ê╪¬ ┘ê ┌⌐╪│╪¿ ╪º┘à╪¬█î╪º╪▓╪î ╪¿╪º█î╪» ╪¿┘ç ╪▒╪¬╪¿┘ç ╪╖┘ä╪º █î╪º ╪º┘ä┘à╪º╪│ ╪»╪│╪¬ █î╪º╪¿█î╪».
                  </p>
                  <p class="text-body-2 text-medium-emphasis mb-6">
                    ╪¿╪▒╪º█î ╪»╪│╪¬█î╪º╪¿█î ╪¿┘ç ╪▒╪¬╪¿┘ç ╪╖┘ä╪º ┘å█î╪º╪▓ ╪¿┘ç ╪¡╪»╪º┘é┘ä █╡█░█░ ╪º┘à╪¬█î╪º╪▓ ┘ê ╪º┘à╪¬█î╪º╪▓ ╪º╪╣╪¬╪¿╪º╪▒ █╢█░+ ╪»╪º╪▒█î╪».
                  </p>
                  <v-btn
                    color="primary"
                    variant="flat"
                ...
                <div v-else>
                  ...
                  <h3 class="text-h6 font-weight-bold mb-2">┘ç┘à┌⌐╪º╪▒╪º┘å ╪«┘ê╪» ╪▒╪º ╪»╪╣┘ê╪¬ ┌⌐┘å█î╪»</h3>
                  <p class="text-body-2 text-medium-emphasis mb-6">
                    ╪º╪▓ ┘ç┘à┌⌐╪º╪▒╪º┘å ┘à╪╣╪¬╪¿╪▒ ╪«┘ê╪» ╪»╪╣┘ê╪¬ ┌⌐┘å█î╪» ╪¬╪º ╪┤┘à╪º ╪▒╪º ╪¬╪º╪ª█î╪» ┘å┘à╪º█î┘å╪»╪î ╪¿╪º ╪º█î┘å┌⌐╪º╪▒ ╪¿┘ç ╪ó┘å┘ç╪º ┘ç╪»█î┘ç ┘à█î ╪»┘ç█î╪» ┘ê ╪¿╪º╪╣╪½ ╪º┘ü╪▓╪º█î╪┤ ╪º╪╣╪¬╪¿╪º╪▒ ╪┤╪▒┌⌐╪¬ ╪«┘ê╪» ┘à█î ╪┤┘ê█î╪».
                  </p>
                  <v-btn
                    color="primary"
                    size="large"
            ...
            <v-window-item value="miniwebsite">
              <div class="py-4">
                <v-tabs v-model="miniWebsiteTab" bg-color="surface" class="mb-4">
                  ...
                  <v-tab value="settings">تنظیمات پایه</v-tab>
                  <v-tab value="portfolio">نمونه کارها</v-tab>
                  <v-tab value="team">تیم من</v-tab>
                  ...
                  <v-window-item value="profile">
                    <v-card elevation="2" rounded="xl" class="pa-6 mt-4">
                      <div class="d-flex align-center mb-6">
                        ...
                        <h3 class="text-h5 font-weight-bold">ویرایش پروفایل</h3>
                      </div>
                      
                      <v-row>
                        <v-col cols="12" lg="4">
                          <FormQualityScore
                            title="کیفیت پروفایل شما"
                            caption="پروفایل کامل = امتیاز بالاتر"
                            :score="profileScore"
                      ...
                      <div v-if="showProductForm">
                        <div class="d-flex align-center mb-6 border-b pb-4">
                          ...
                          <h3 class="text-h6 font-weight-bold text-primary">
                            {{ editingProduct ? '┘ê█î╪▒╪º█î╪┤ ┘à╪¡╪╡┘ê┘ä' : '╪º┘ü╪▓┘ê╪»┘å ┘à╪¡╪╡┘ê┘ä ╪¼╪»█î╪»' }}
                          </h3>
                        </div>
                        <SupplierProductForm
                    ...
                    <v-card elevation="2" rounded="xl" height="650" class="d-flex flex-column">
                      <div class="pa-4 bg-grey-lighten-5 border-b">
                        <div class="d-flex justify-space-between align-center">
                          <span class="font-weight-bold text-primary">گفتگوها</span>
                      ...
                      <v-list v-if="!loadingChats" class="flex-grow-1 overflow-y-auto py-0">
                        ...
                        >
                          ...
                          <v-list-item-subtitle class="text-caption">
                            ...
                            <span v-else class="text-disabled">هنوز پیامی ارسال نشده</span>
                          </v-list-item-subtitle>
                      ...
                      <v-card v-else-if="!loadingChats && chatRooms.length === 0" elevation="0" class="flex-grow-1 d-flex align-center justify-center">
                        <div class="text-center text-medium-emphasis">
                          ...
                          <div class="text-body-1">هنوز پیامی ارسال نشده</div>
                        </div>
                      </v-card>
                    </v-card>
                  </v-col>
                  ...
                  <v-col cols="12" md="8">
                      ...
                      <v-toolbar density="compact" color="surface" class="border-b pr-4">
                         ...
                         <div class="d-flex flex-column">
                             ...
                             <span v-if="selectedChatRoom.product_name" class="text-caption text-medium-emphasis">
                                محصول: {{ selectedChatRoom.product_name }}
                             </span>
                         </div>
                         <v-spacer></v-spacer>
                         <v-btn
                    ...
                    <v-card v-else elevation="2" rounded="xl" height="650" class="d-flex align-center justify-center bg-grey-lighten-5">
                      <div class="text-center text-medium-emphasis">
                        ...
                        <div class="text-h6">یک گفتگوی را انتخاب کنید</div>
                      </div>
                    </v-card>
                  </v-col>
                </v-row>
                ...
                <v-card elevation="2" rounded="xl">
                  <v-card-title class="d-flex align-center justify-space-between pa-6">
                    <div class="d-flex align-center gap-2">
                      ...
                      <span class="text-h6 font-weight-bold">پرداخت‌ها و تسویه‌ها</span>
                    </div>
                    <v-btn
...
import PremiumDiscountBox from '~/components/seller/PremiumDiscountBox.vue'
...
const discountCode = ref<string | undefined>(undefined)
...
const getUserFullName = () => {
  ...
  if (firstName || lastName) {
    return `${firstName} ${lastName}`.trim() || user.username || '┌⌐╪º╪▒╪¿╪▒'
  }
  return user.username || '┌⌐╪º╪▒╪¿╪▒'
}
...
const formatChatTime = (timestamp: string) => {
  ...
  if (minutes < 1) return '╪º┘ä╪º┘å'
  if (minutes < 60) return `${minutes} ╪»┘é█î┘é┘ç ┘╛█î╪┤`
  if (hours < 24) return `${hours} ╪│╪º╪╣╪¬ ┘╛█î╪┤`
  if (days < 7) return `${days} ╪▒┘ê╪▓ ┘╛█î╪┤`
...
const getLeadName = (lead: CustomerLead) => {
  ...
  return name || lead.company_name || '┘à╪┤╪¬╪▒█î'
}

const getLeadCategoryLabel = (lead: CustomerLead) => {
  if (lead.is_free) return '╪▒╪º█î┌»╪º┘å'
  return lead.category_name || '┘à╪▒╪¬╪¿╪╖ ╪¿╪º ┘à╪¡╪╡┘ê┘ä╪º╪¬ ╪┤┘à╪º'
}
...
const onProductSaved = async () => {
  ...
  showSnackbar('┘à╪¡╪╡┘ê┘ä ╪¿╪º ┘à┘ê┘ü┘é█î╪¬ ╪░╪«█î╪▒┘ç ╪┤╪»', 'success')
}
...
const completeTaskAndCelebrate = async (taskType: string, metadata: Record<string, any> = {}) => {
  try {
    ...
    if (result.data.value && result.data.value.celebration) {
      ...
      celebrationMessage.value = result.data.value.message || '╪╣╪º┘ä█î! █î┌⌐ ┘é╪»┘à ╪¿┘ç ┘à┘ê┘ü┘é█î╪¬ ┘å╪▓╪»█î┌⌐ΓÇî╪¬╪▒ ╪┤╪»█î╪».'
...
const handlePremiumSuccess = () => {
  showSnackbar('پرداخت با موفقیت انجام شد و پلن پریمیوم فعال گردید', 'success')
  // Reload gamification data to update tier status
  loadDashboardGamification()
}
...
const updateProfile = async () => {
  ...
  try {
    ...
    showSnackbar('پروفایل با موفقیت بروزرسانی شد', 'success')
    // Refresh user data
    ...
    showSnackbar(error?.message || 'خطا در بروزرسانی پروفایل', 'error')
  } finally {
    saving.value = false
  }
}
...
const orderHeaders = ref([
  { title: '╪┤┘à╪º╪▒┘ç ╪│┘ü╪º╪▒╪┤', key: 'order_number', align: 'start' as const },
  { title: '╪«╪▒█î╪»╪º╪▒', key: 'buyer_username', align: 'start' as const },
  { title: '┘à╪¿┘ä╪║', key: 'total_amount', align: 'start' as const },
  { title: '┘ê╪╢╪╣█î╪¬', key: 'status', align: 'start' as const },
  { title: '╪¬╪º╪▒█î╪«', key: 'created_at', align: 'start' as const }
])

const auctionHeaders = ref([
  { title: 'شناسه', key: 'id', sortable: true },
  { title: 'وضعیت سپرده', key: 'deposit_status', sortable: true },
  { title: 'تعداد پیشنهادات', key: 'bid_count', sortable: true },
...
const reviewHeaders = ref([
  ...
  { title: '╪¬╪º╪▒█î╪«', key: 'created_at', align: 'start' }
])
...
const loadDashboardData = async () => {
  ...
  try {
    ...
    showSnackbar('╪«╪╖╪º ╪»╪▒ ╪¿╪º╪▒┌»╪░╪º╪▒█î ╪º╪╖┘ä╪º╪╣╪º╪¬ ╪»╪º╪┤╪¿┘ê╪▒╪»', 'error')
  } finally {
    loading.value = false
  }
}
...
const loadOrders = async () => {
  ...
  try {
    ...
    showSnackbar('خطا در بارگذاری سفارش‌ها', 'error')
  } finally {
...
const loadInsights = async () => {
  ...
  try {
    ...
    insightsError.value = error?.message || '╪«╪╖╪º ╪»╪▒ ╪¿╪º╪▒┌»╪░╪º╪▒█î ╪¿█î┘å╪┤ΓÇî┘ç╪º'
    showSnackbar('╪«╪╖╪º ╪»╪▒ ╪¿╪º╪▒┌»╪░╪º╪▒█î ╪¿█î┘å╪┤ΓÇî┘ç╪º', 'error')
  } finally {
...
const handleCreateInsight = async (payload: { title: string; content: string }) => {
  ...
  try {
    ...
    showSnackbar('┘å┌⌐╪¬┘ç ╪┤┘à╪º ╪¿┘ç ╪╡┘ê╪▒╪¬ ╪╣┘à┘ê┘à█î ┘à┘å╪¬╪┤╪▒ ╪┤╪» ┘ê ╪¿╪▒╪º█î ╪«╪▒█î╪»╪º╪▒╪º┘å ┘é╪º╪¿┘ä ┘à╪┤╪º┘ç╪»┘ç ╪º╪│╪¬', 'success')
    ...
    showSnackbar(error?.message || '╪½╪¿╪¬ ┘å┌⌐╪¬┘ç ╪¬╪«╪╡╪╡█î ┘å╪º┘à┘ê┘ü┘é ╪¿┘ê╪»', 'error')
  } finally {
...
const handleLikeInsight = async (insightId: number) => {
  try {
    ...
    showSnackbar(error?.message || '╪«╪╖╪º ╪»╪▒ ╪½╪¿╪¬ ┘ä╪º█î┌⌐', 'error')
  }
}
...
const loadInsightComments = async (insightId: number) => {
  ...
  try {
    ...
    insightCommentsError.value = {
      ...insightCommentsError.value,
      [insightId]: error?.message || '╪«╪╖╪º ╪»╪▒ ╪¿╪º╪▒┌»╪░╪º╪▒█î ╪»█î╪»┌»╪º┘çΓÇî┘ç╪º'
    }
  } finally {
...
const handleCreateInsightComment = async (payload: { id: number; content: string }) => {
  ...
  try {
    ...
    showSnackbar('نظر با موفقیت ارسال شد', 'success')
  } catch (error: any) {
    console.error('Failed to add comment:', error)
    insightCommentsError.value = {
      ...insightCommentsError.value,
      [id]: error?.message || 'خطا در ارسال نظر'
    }
  } finally {
...
const loadCustomerPool = async () => {
  ...
  try {
    ...
    showSnackbar('╪«╪╖╪º ╪»╪▒ ╪¿╪º╪▒┌»╪░╪º╪▒█î ╪»╪▒╪«┘ê╪º╪│╪¬ ┘ç╪º█î ╪«╪▒█î╪» ╪▒╪º█î┌»╪º┘å', 'error')
  } finally {
  ...
  try {
    ...
    if (normalizedLead.phone_number) {
      ...
      if (existingContact) {
        ...
        showSnackbar('╪º█î┘å ┘à╪«╪º╪╖╪¿ ┘é╪¿┘ä╪º┘ï ╪»╪▒ CRM ╪┤┘à╪º ╪½╪¿╪¬ ╪┤╪»┘ç ╪º╪│╪¬╪î ╪¿╪▒╪º█î ┘à╪┤╪º┘ç╪»┘ç ╪¿┘ç CRM ┘à╪▒╪º╪¼╪╣┘ç ┌⌐┘å█î╪».', '┘ç╪┤╪»╪º╪▒')
        return
      }
    }
    ...
    try {
      ...
      showSnackbar('╪º╪╖┘ä╪º╪╣╪º╪¬ ╪¿╪º ┘à┘ê┘ü┘é█î╪¬ ╪¿┘ç CRM ╪º╪╢╪º┘ü┘ç ╪┤╪». ╪¿╪▒╪º█î ┘à╪┤╪º┘ç╪»┘ç ╪¿┘ç ╪¬╪¿ CRM ┘à╪▒╪º╪¼╪╣┘ç ┌⌐┘å█î╪».', 'success')
    } catch (crmError: any) {
      console.error('Failed to add contact to CRM:', crmError)
      // Don't show contact info if CRM add fails
      showSnackbar('╪«╪╖╪º ╪»╪▒ ╪º┘ü╪▓┘ê╪»┘å ╪¿┘ç CRM. ┘ä╪╖┘ü╪º┘ï ╪»┘ê╪¿╪º╪▒┘ç ╪¬┘ä╪º╪┤ ┌⌐┘å█î╪».', 'error')
    }
  } catch (error: any) {
    ...
    let errorMessage = '╪»╪│╪¬╪▒╪│█î ╪¿┘ç ╪º█î┘å ┘à╪┤╪¬╪▒█î ┘à┘à┌⌐┘å ┘å█î╪│╪¬'
    
    // Handle 429 rate limit error specifically
    if (statusCode === 429) {
      errorMessage = error?.data?.detail || '╪┤┘à╪º ╪¿┘ç ╪¡╪» ┘à╪¼╪º╪▓ ╪▒┘ê╪▓╪º┘å┘ç ╪¿╪▒╪º█î ┘à╪┤╪º┘ç╪»┘ç ┘à╪┤╪¬╪▒█î┘ç╪º█î ╪¼╪»█î╪» ╪▒╪│█î╪»┘çΓÇî╪º█î╪». ┘ä╪╖┘ü╪º┘ï ╪¿╪╣╪»╪º┘ï ╪¬┘ä╪º╪┤ ┌⌐┘å█î╪».'
...
const loadChatRooms = async () => {
  ...
  try {
    ...
    showSnackbar('╪«╪╖╪º ╪»╪▒ ╪¿╪º╪▒┌»╪░╪º╪▒█î ┌»┘ü╪¬┌»┘ê┘ç╪º', 'error')
  } finally {
  ...
  return [
    {
      key: 'first_name',
      label: 'نام',
      tip: 'نام کوچک را کامل وارد کنید تا مشتریان شما را بهتر شناسایی کنند و اعتماد بیشتری به پروفایل شما داشته باشند.',
      weight: 0.25,
      passed: hasFirstName
    },
    {
      key: 'last_name',
      label: 'نام خانوادگی',
      tip: 'نام خانوادگی کامل خود را وارد کنید تا پروفایل شما حرفه‌ای‌تر به نظر برسد و مشتریان شما را بهتر شناسایی کنند.',
      weight: 0.25,
      passed: hasLastName
    },
    {
      key: 'email',
      label: 'ایمیل',
      tip: 'یک ایمیل معتبر وارد کنید تا مشتریان بتوانند با شما تماس بگیرند و اعتماد بیشتری به پروفایل شما داشته باشند.',
      weight: 0.25,
    ...
    },
    {
      key: 'phone',
      label: 'شماره تماس',
      tip: 'شماره تماس معتبر خود را وارد کنید تا مشتریان بتوانند مستقیماً با شما ارتباط برقرار کنند. شماره تماس معتبر = امتیاز بالاتر.',
      weight: 0.25,
...
const getDepositBadgeLabel = (status: string) => {
  if (status === 'held_in_escrow') return 'سپرده نزد امانت'
