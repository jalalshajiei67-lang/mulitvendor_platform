...
def robots_txt(request):
    ...
    robots_lines = [
        ...
        'Disallow: /tinymce/',
        '',
        '# Disallow authentication and checkout flows (user-specific)',
        'Disallow: /login',
        'Disallow: /register',
        'Disallow: /logout',
        'Disallow: /cart',
        ...
        'Disallow: /account',
        '',
        '# Disallow backend host mirrors and any paths containing the backend domain',
        'Disallow: /https://multivendor-backend.indexo.ir/',
        'Disallow: /multivendor-backend.indexo.ir/',
        '',
