...
echo "=========================================="
echo "📋 Staging Apps Setup Instructions"
echo "=========================================="
echo ""
echo "⚠️  IMPORTANT: Apps must be created via CapRover Dashboard"
echo "   This script only shows what you need to do."
echo ""
echo "🔗 CapRover Dashboard: https://captain.indexo.ir"
echo ""
echo "=========================================="
echo "1️⃣  CREATE BACKEND APP"
echo "=========================================="
echo ""
echo "1. Go to: https://captain.indexo.ir"
echo "2. Navigate to: Apps → Create New App"
echo "3. App Name: multivendor-backend-staging"
echo "   (or match your CAPROVER_BACKEND_STAGING_APP_NAME secret)"
echo "4. Has Persistent Data: ✅ YES"
echo "5. Enable HTTPS: ✅ YES"
...
echo ""
echo "=========================================="
echo "3️⃣  VERIFY GITHUB SECRETS"
echo "=========================================="
echo ""
